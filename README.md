<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:4F46E5,100:06B6D4&height=200&section=header&text=Hi,%20I'm%20Diego%20Matías!&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=35" width="100%"/>
  ...
  <p>
    ...
    <a href="mailto:diego.calderon3@unmsm.edu.pe">
...
I am a **9th-cycle Software Engineering student** at **UNMSM** (Lima, Peru). I enjoy working across the full lifecycle of a solution — from analyzing data and modeling processes, to building the software that puts it into action.
I am currently looking for an internship opportunity as a **Data Analyst**, **Process Analyst**, or **Software Developer**, where I can keep applying my skills in Python, SQL, and Full Stack Development.

- 🔭 **I'm currently working on:** a mobile app with AI-powered image classification (Flutter + Flask/TensorFlow), and process/requirements analysis using BPMN.
- 🌱 **I'm currently learning:** AWS services for data (S3, Athena, SageMaker) and Generative AI applied to software development.
- 👯 **I'm looking to collaborate on:** Data Analytics, Business Process Automation, and Open Source projects.
